...
import { useConfirmLoginMutation } from "@/redux/Auth/auth-slice";
import { useAppDispatch, useAppSelector } from "@/redux/store";
import { t, Trans } from "@lingui/macro";
import React, { Dispatch, SetStateAction, useEffect, useState } from "react";
import { z } from "zod";
import styles from "./DeleteConfirmedEmailCodeModal.module.scss";
...
interface IProps {
  ...
  showConfirmDeleteModal: (isOpen: boolean) => void;
...
export const DeleteConfirmedEmailCodeModal: React.FC<IProps> = ({
  onClose,
  isOpen,
  user,
  handleServerError,
  ...
  }, [setOneTimeCodeReference, setValues, values.token]);
